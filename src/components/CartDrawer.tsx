                ...
                <div className="flex items-center justify-between text-xs mb-1.5 font-medium">
                  {remainingForFreeDelivery > 0 ? (
                    <span className={isLight ? 'text-slate-700' : 'text-gray-300'}>
                      Add <strong className={isLight ? 'text-[#B88728]' : 'text-[#E5B65F]'}>${remainingForFreeDelivery.toFixed(2)}</strong> for Free Delivery
                    </span>
                  ) : (
            ...
            {cart.length > 0 && (
              <div className={`p-5 sm:p-6 border-t ${
                ...
                <div className={`flex items-center justify-center gap-1.5 text-[11px] mt-3 ${
                  ...
                  <ShieldCheck size={13} className={isLight ? 'text-[#B88728]' : 'text-[#E5B65F]'} />
