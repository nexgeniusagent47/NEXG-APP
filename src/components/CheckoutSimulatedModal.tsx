        ...
        >
          ...
          <div className={`p-5 sm:p-6 border-b flex items-center justify-between transition-colors ${
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#E5B65F]/20 text-[#B88728] dark:text-[#E5B65F] border border-[#E5B65F]/40 flex items-center justify-center font-bold">
                <CreditCard size={20} />
              </div>
              <div>
          ...
          <div className="p-5 sm:p-7 overflow-y-auto space-y-6 flex-grow custom-scrollbar">
            ...
            <div className="space-y-4">
              <div className={`flex items-center gap-2 text-sm font-extrabold tracking-wide ${
                ...
                <MapPin size={16} className="text-[#B88728] dark:text-[#E5B65F]" />
            ...
            <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-white/10">
              <div className="flex items-center justify-between">
                <div className={`flex items-center gap-2 text-sm font-extrabold tracking-wide ${
                  ...
                  <CreditCard size={16} className="text-[#B88728] dark:text-[#E5B65F]" />
                  <span>Choose Simulated Payment Method</span>
                </div>
                <span className="text-[11px] font-bold px-2 py-0.5 rounded border bg-amber-500/10 border-amber-500/30 text-[#B88728] dark:text-[#E5B65F]">
              ...
              {paymentMethod === 'card' && (
                <div className={`p-3.5 rounded-xl border space-y-2 mt-2 ${
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="font-bold text-[#B88728] dark:text-[#E5B65F]">Visa Infinite • 8492</span>
                  </div>
                  <input
                    type="text"
                    value={cardHolder}
          ...
          <div className={`p-5 sm:p-6 border-t ${
            ...
            {isProcessing ? (
              <div className={`w-full py-4 rounded-2xl border flex flex-col items-center justify-center gap-2 text-center ${
                ...
                <div className="flex items-center gap-2 text-sm font-bold text-[#B88728] dark:text-[#E5B65F]">
