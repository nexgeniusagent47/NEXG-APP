      ...
      <div className={`flex flex-col gap-2 ${className}`}>
        <div className="flex items-center justify-between">
          <span className={`text-xs font-semibold flex items-center gap-1.5 ${
            ...
            <Globe size={14} className="text-[#B88728] dark:text-[#E5B65F]" />
  ...
  if (variant === 'footer') {
    return (
      <div className={`relative ${className}`} ref={containerRef}>
        ...
        >
          <span className="text-[#B88728] dark:text-[#E5B65F] flex items-center justify-center">
                ...
                {options.map((opt) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <Check size={14} className="text-[#B88728] dark:text-[#E5B65F]" />
                      )}
                    </button>
                  );
                })}
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex items-center gap-1.5 px-3 py-2 border-b border-black/5 dark:border-white/5 mb-1">
              <Globe size={13} className="text-[#B88728] dark:text-[#E5B65F]" />
              <span className={`text-[11px] font-bold uppercase tracking-wider ${
                isLight ? 'text-slate-600' : 'text-gray-300'
              }`}>
                {t.nav.selectLanguage}
              ...
              {options.map((opt) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && (
                      <Check size={16} className="text-[#B88728] dark:text-[#E5B65F] shrink-0 ml-2" />
                    )}
                  </button>
                );
              })}
