      ...
      {!selectedMerchant ? (
        <div className="max-w-[1480px] mx-auto px-4 sm:px-8">
          ...
          <div className="flex items-center justify-between py-4 mb-4 border-b border-slate-200 dark:border-white/10">
            <div className="flex items-center gap-3">
              ...
              >
                <ArrowLeft size={16} />
                <span>{t.ui.restaurants.s_a1e9f9}</span>
              </button>
              <span className={isLight ? 'text-slate-300' : 'text-gray-600'}>/</span>
              <span className={`text-xs sm:text-sm font-extrabold ${isLight ? 'text-[#7d5a11]' : 'text-[#E5B65F]'}`}>{t.ui.restaurants.s_6b2c05}</span>
            </div>
          ...
          <div className="relative rounded-3xl overflow-hidden mb-8 shadow-xl border border-slate-200/80 dark:border-white/10">
            ...
            <div className="relative z-10 p-6 sm:p-12 max-w-2xl">
              ...
              <div className={`flex items-center rounded-2xl p-1.5 border shadow-lg ${
                ...
                <input
                  type="text"
                  placeholder={t.ui.restaurants.s_34df71}
                  value={searchQuery}
              ...
              return (
                ...
                >
                  ...
                  <div className="relative aspect-[16/10] overflow-hidden bg-slate-200 dark:bg-black/50">
                    ...
                    {restaurant.featured && (
                      <span className="absolute top-3 left-3 bg-[#E5B65F] text-black text-[9.5px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full shadow-md">{t.ui.restaurants.s_9da221}</span>
                    )}
                  </div>
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <div className="mb-4">
                      <button
                        ...
                        title={t.ui.restaurants.s_d97dd5}
                      >
                    ...
                    <div className="mt-auto pt-3 border-t border-slate-200 dark:border-white/10 flex items-center justify-between gap-2">
                      ...
                      >
                        ...
                        <span>{t.ui.restaurants.s_072c89}</span>
                      </button>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {restaurant.socials.googleMaps && (
                            <a
                              ...
                              title={t.ui.restaurants.s_4f9fa0}
                            >
                              <MapPin size={13} />
                            </a>
                          )}
          ...
          {filteredRestaurants.length === 0 && (
            <div className={`text-center py-20 rounded-2xl border ${
              ...
              <h4 className={`text-lg font-bold mb-1 ${isLight ? 'text-slate-900' : 'text-white'}`}>{t.ui.restaurants.s_eac205}</h4>
              <p className={`text-xs max-w-sm mx-auto mb-4 ${isLight ? 'text-slate-600' : 'text-gray-400'}`}>{t.ui.restaurants.s_5f716b}</p>
              <button
                onClick={() => {
                  setSearchQuery('');
              ...
              >{t.ui.restaurants.s_5be698}</button>
            </div>
          )}
        </div>
      ) : (
        ...
        <div className="max-w-[1480px] mx-auto px-4 sm:px-8">
          ...
          <div className="flex items-center justify-between py-4 mb-6 border-b border-slate-200 dark:border-white/10">
            ...
            >
              <ArrowLeft size={16} />
              <span>{t.ui.restaurants.s_bf0c7d}</span>
            </button>
          ...
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h2 className={`text-2xl font-bold tracking-tight ${isLight ? 'text-slate-900' : 'text-white'}`}>{t.ui.restaurants.s_ae0cb2}</h2>
              <p className={`text-xs sm:text-sm font-medium ${isLight ? 'text-slate-600' : 'text-gray-400'}`}>{t.ui.restaurants.s_868fb0}</p>
            </div>
            ...
            <div className={`flex items-center rounded-xl p-1.5 border w-full sm:w-72 ${
              ...
              <input
                type="text"
                placeholder={t.ui.restaurants.s_cfdf8b}
                value={dishSearch}
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto pt-3 border-t border-slate-200 dark:border-white/10 flex items-center justify-between">
                      ...
                      <span className={`text-xs font-bold flex items-center gap-1 ${
                        ...
                        <span>{t.ui.restaurants.s_dde236}</span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-md">
          ...
          >
            <div className="p-6 border-b border-slate-200 dark:border-white/10 flex items-center justify-between">
              <div>
                <span className="text-[10px] uppercase font-bold tracking-widest text-[#7d5a11] dark:text-[#E5B65F]">{t.ui.restaurants.s_0c8f01}</span>
              ...
              {!bookingModalConfig.isConfirmed ? (
                <>
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-200 dark:border-white/10 flex items-center justify-between">
                    <div>
                      <div className="text-xs text-gray-400">{t.ui.restaurants.s_25b120}</div>
                    ...
                    >{t.ui.restaurants.s_2c3b25}</button>
                  </div>
                </>
              ) : (
                <div className="text-center py-8">
                  ...
                  <p className={`text-xs max-w-md mx-auto mb-6 leading-relaxed ${
                    isLight ? 'text-slate-600' : 'text-gray-300'
                  }`}>{t.ui.restaurants.s_0721cf}<span className="font-bold">{bookingModalConfig.restaurantName}</span> has been locked for {bookingModalConfig.selectedDate} at {bookingModalConfig.selectedTime} for {bookingModalConfig.guests} guests.
                  </p>
                  <button
                    onClick={() => setBookingModalConfig((prev) => ({ ...prev, isOpen: false }))}
