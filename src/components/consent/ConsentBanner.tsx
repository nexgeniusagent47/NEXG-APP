...
export default function ConsentBanner() {
  ...
  return (
    ...
    <div className="onboarding-theme fixed inset-x-0 bottom-0 z-[300] p-3 print:hidden pointer-events-none">
      <section
        role="region"
        aria-label={t.ui.consentBanner.s_e7d306}
      ...
      >
        <div className="p-4 sm:p-5">
          <h2 className="text-base font-semibold text-slate-900">{t.ui.consentBanner.s_788df5}</h2>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            >{t.ui.consentBanner.s_821d1f}</button>
            <button
              type="button"
              data-analytics="consent-reject-all"
              onClick={() => rejectAll()}
              className="rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100"
            >{t.ui.consentBanner.s_35c291}</button>
            <button
              type="button"
              ...
              className="rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100"
            >{t.ui.consentBanner.s_956fa7}</button>
          </div>
          ...
          <p className="mt-3 text-xs text-slate-600">{t.ui.consentBanner.s_da6a92}</p>
        </div>
      </section>
    </div>
  );
...
export function CookieSettingsLink({ className }: { className?: string }) {
  ...
  return (
    ...
    >{t.ui.consentBanner.s_9e0cba}</button>
  );
}
