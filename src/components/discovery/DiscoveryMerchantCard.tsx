      ...
      <div className="p-4 flex flex-col flex-grow gap-2">
        <div className="flex items-start justify-between gap-2">
          <h3
            className={cn(
              ...
              'group-hover:text-[#B88728] dark:group-hover:text-[#E5B65F]',
        ...
        >
          <span className="inline-flex items-center gap-1">
            <MapPin size={12} className="text-[#B88728] dark:text-[#E5B65F]" />
            {merchant.nairobiArea}
          </span>
          <span className="inline-flex items-center gap-1">
            <Bike size={12} className="text-[#B88728] dark:text-[#E5B65F]" />
