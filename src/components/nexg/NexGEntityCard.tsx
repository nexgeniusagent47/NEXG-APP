        ...
        <div className="flex flex-col justify-between flex-grow min-w-0 py-0.5">
          <div className="space-y-1">
            <div className="flex items-center justify-between gap-1">
              {entity.category && (
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#7d5a11] dark:text-[#E5B65F] truncate">
                  {entity.category}
                </span>
              )}
              {entity.rating && (
            ...
            <div className="flex items-center gap-3 text-xs">
              {entity.deliveryTime && (
                <span className="flex items-center gap-1 text-[11px] font-medium text-slate-500 dark:text-gray-400">
                  <Clock size={11} className="text-[#7d5a11] dark:text-[#E5B65F]" />
                  {entity.deliveryTime}
                </span>
              )}
              {entity.duration && (
      ...
      >
        ...
        <div className="p-2.5 space-y-1">
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            {entity.price !== undefined && (
              <p className="font-extrabold text-[#7d5a11] dark:text-[#E5B65F]">
          ...
          <div className="flex items-center gap-3 text-xs">
            ...
            {entity.deliveryTime && (
              <div className="flex items-center gap-1 font-medium text-slate-500 dark:text-gray-400">
                <Clock className="w-3.5 h-3.5 text-[#7d5a11] dark:text-[#E5B65F]" />
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-between flex-grow p-4 space-y-2.5">
        <div className="space-y-1">
          {entity.category && (
            <span className="uppercase tracking-wider text-[10px] font-bold text-[#7d5a11] dark:text-[#E5B65F] block truncate">
              {entity.category}
            </span>
          )}
