        ...
        {hasMore ? (
          <div className="flex flex-col items-center gap-2">
            ...
            >
              {isLoadingMore ? (
                <>
                  <Loader2 className="w-3.5 h-3.5 animate-spin text-[#B88728] dark:text-[#E5B65F]" />
                  <span>Loading more curated {itemTypeLabel}...</span>
                </>
              ) : (
                <>
                  <ChevronDown className="w-3.5 h-3.5 text-[#B88728] dark:text-[#E5B65F]" />
                  <span>
          ...
          <div className="py-4 text-center">
            ...
            >
              <Sparkles className="w-3 h-3 text-[#B88728] dark:text-[#E5B65F]" />
